...
## A minimal interactable for a character that already has its own body/
## script elsewhere in the scene (e.g. Guard's vision-cone owner) and just
## needs a name, portrait, and flavor lines to be talkable.
